...
# Frontend Mentor - página de destino da área de transferência

! [Visualização do design para o desafio de codificação da página de destino da área de transferência] (./ design / desktop-preview.jpg)
...
Sua tarefa é construir o projeto para os designs dentro da pasta `/ design`. Você encontrará um design móvel, um design de desktop e também um design para os estados de foco trabalharem.
